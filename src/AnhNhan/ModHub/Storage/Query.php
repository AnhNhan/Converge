...
abstract class Query
{
    ...
    {
        return idx(array(
            self::EXT_QUERY_FORUM => 'AnhNhan\ModHub\Modules\Forum\Query\DiscussionQuery',
            self::EXT_QUERY_ROLE  => 'AnhNhan\ModHub\Modules\User\Query\RoleQuery',
            self::EXT_QUERY_TAG   => 'AnhNhan\ModHub\Modules\Tag\TagQuery',
            self::EXT_QUERY_USER  => 'AnhNhan\ModHub\Modules\User\Query\UserQuery',
        ), $name);
    }
