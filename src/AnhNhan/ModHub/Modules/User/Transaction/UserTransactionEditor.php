<?php
namespace AnhNhan\ModHub\Modules\User\Transaction;
...
final class UserTransactionEditor extends TransactionEditor
{
    ...
    {
        static $entityRole = 'AnhNhan\ModHub\Modules\User\Storage\Role';
        static $entityEmail = 'AnhNhan\ModHub\Modules\User\Storage\Email';
    ...
    {
        $userReflProp = $this->em()->getClassMetadata('AnhNhan\ModHub\Modules\User\Storage\User')
