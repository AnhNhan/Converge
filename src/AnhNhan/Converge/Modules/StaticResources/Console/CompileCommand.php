...
final class CompileCommand extends ConsoleCommand
{
    ...
    {
        parent::__construct();
        self::$path_resource = Converge\get_root_super() . "resources" . DIRECTORY_SEPARATOR;
        self::$path_cache = Converge\get_root_super() . "cache" . DIRECTORY_SEPARATOR;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($js) {
            ...
            $jsBuilderClass = 'AnhNhan\Converge\Modules\StaticResources\Builders\JsBuilder';
