...
CREATE TABLE PostTransaction (id VARCHAR(255) NOT NULL, object_id VARCHAR(255) DEFAULT NULL, actor VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, oldValue LONGTEXT NOT NULL, newValue LONGTEXT NOT NULL, metadata LONGTEXT NOT NULL, createdAt DATETIME NOT NULL, modifiedAt DATETIME NOT NULL, INDEX IDX_3C5D4D21232D562B (object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
